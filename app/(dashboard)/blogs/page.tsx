    ...
    return (
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Manage your safari blog content and articles</p>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {blogs ? new Set(blogs.map((blog: Blog) => blog.author_name)).size : 0}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start creating amazing content for your safari adventures.</p>
            <Link 
              href="/blogs/create"
