  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg">Monitor your safari business performance and insights</p>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{metrics?.totalGuests || 0}</p>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{metrics?.completionRate?.toFixed(1) || 0}%</p>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {bookingsData.bookings.slice(0, 5).map((booking) => (
              <div key={booking.id} className="px-6 py-4 hover:bg-gray-50 transition-colors duration-200">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <h4 className="font-medium text-gray-900">{booking.full_name}</h4>
                    <p className="text-sm text-gray-600">{booking.itinerary.title}</p>
                    <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        {booking.number_of_adults + booking.number_of_children} guests
                      </span>
                    </div>
                  </div>
      ...
      {(!bookingsData?.bookings || bookingsData.bookings.length === 0) && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">When customers start booking safaris, you'll see their information here.</p>
        </div>
      )}
    </div>
  )
