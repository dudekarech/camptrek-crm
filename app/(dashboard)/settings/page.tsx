...
import { Users, Settings as SettingsIcon, Zap, UserPlus, User } from 'lucide-react'
import { useStaffStore } from '@/store/StaffStore'

type ActiveProp = {
  tab: "user" | "staff" | "automation" | "profile"
}
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl shadow-lg mb-4">
          {isStaff ? <User className="w-8 h-8 text-white" /> : <SettingsIcon className="w-8 h-8 text-white" />}
        </div>
